...
class PersonForm_controller {
    constructor(model, view, root_element) {
        ...
        this.view.bind_inputToData_onChange(this.view.name, this.nameChange.bind(this));
        this.view.bind_inputToData_onChange(this.view.surname, this.surnameChange.bind(this));
        this.view.bind_inputToData_onChange(this.view.birthDate, this.birthDateChange.bind(this));
        this.view.bind_inputToData_onChange(this.view.adress, this.adressChange.bind(this));
        this.view.bind_inputToData_onChange(this.view.idNumber, this.idChange.bind(this));
